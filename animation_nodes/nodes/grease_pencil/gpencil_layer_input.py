...
class GPencilLayerInputNode(bpy.types.Node, AnimationNode):
    ...
    def execute_ActiveFrame(self, layer, scene):
        ...
        return frames[activeIndex], activeIndex, frameNumbers[activeIndex], layer.layerName, layer.blendMode, layer.opacity
    ...
    def execute_FrameIndex(self, layer, frameIndex):
        ...
        frameNumbers = layer.frameNumbers
        return frame, frameNumbers[frameIndex], layer.layerName, layer.blendMode, layer.opacity

    def execute_FrameIndices(self, layer, frameIndices):
        frames = layer.frames
        outFrames = []
        if len(layer.frames) == 0:
            return outFrames, LongList()
        frameNumbers = layer.frameNumbers
        ...
        return outFrames, outFrameNumbers, layer.layerName, layer.blendMode, layer.opacity
    ...
    def execute_FrameNumber(self, layer, frameNumber):
        ...
        return frames[index], index, layer.layerName, layer.blendMode, layer.opacity
    ...
    def execute_FrameNumbers(self, layer, inframeNumbers):
        ...
        return outFrames, outFrameIndices, layer.layerName, layer.blendMode, layer.opacity

    def execute_AllFrames(self, layer):
        return layer.frames, layer.frameNumbers, layer.layerName, layer.blendMode, layer.opacity
